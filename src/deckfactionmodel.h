...
#ifndef DECKFACTIONMODEL_H
#define DECKFACTIONMODEL_H

#include "countcardmodel.h"

class DeckFactionModel : public CountCardModel
{
    Q_OBJECT

    Q_PROPERTY(uint deckId READ deckId WRITE setDeckId NOTIFY deckIdChanged)
public:
    explicit DeckFactionModel(QObject *parent = 0);
